...
static const int64 MAX_MONEY = 170000000 * COIN; // Powercoin: maximum of 170M coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 2880 / 250; // Powercoin: 2880 blocks found a day. Priority cutoff is 1 powercoin day / 250 bytes.
    }
...
public:
    ...
    bool AcceptBlock();
    bool CheckCheckpointsVsBlockchain();
...
public:
    ...
    {
        CKey key;
        if (!key.SetPubKey(ParseHex("021b1ef17cf427a735b6f7903f186380ac65e2bd03f9b6df526d0ba37a4787f4ec")))
